...
RowansLab_MapEvents:
	...
	db 4 ; object events
	object_event  4,  4, SPRITE_ELM, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RowansLab_RowanScript, -1
	...
	object_event  2,  8, SPRITE_CHRIS, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RowansLab_DawnLucasFatherScript, -1
	object_event  6,  8, SPRITE_CHRIS, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RowansLab_AideScript, -1
