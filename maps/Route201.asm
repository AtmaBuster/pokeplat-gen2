...
Route201_MapEvents:
	...
	db 8 ; object events
	object_event 18, 12, SPRITE_RIVAL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route201_RivalScript, EVENT_ROUTE_201_RIVAL
	object_event 15, 12, SPRITE_ROWAN, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route201_RowanScript, EVENT_ROUTE_201_ROWAN
	...
	object_event 18, 13, SPRITE_BRIEFCASE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route201_BriefcaseScript, EVENT_ROUTE_201_BRIEFCASE
