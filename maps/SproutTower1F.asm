...
SproutTower1F_MapEvents:
	...
	db 5 ; warp events
	warp_event  9, 17, VIOLET_CITY, 7
	warp_event 10, 17, VIOLET_CITY, 7
	warp_event  6,  6, SPROUT_TOWER_2F, 1
	warp_event  2,  8, SPROUT_TOWER_2F, 2
	warp_event 17,  5, SPROUT_TOWER_2F, 3

	db 0 ; coord events

	db 2 ; bg events
	bg_event  7, 17, BGEVENT_READ, SproutTower1FStatue
	bg_event 12, 17, BGEVENT_READ, SproutTower1FStatue

	db 6 ; object events
	object_event  7,  6, SPRITE_SAGE, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SproutTower1FSage1Script, -1
	object_event  6,  9, SPRITE_SAGE, SPRITEMOVEDATA_WANDER, 1, 1, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, SproutTower1FSage2Script, -1
	object_event 11, 14, SPRITE_GRANNY, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SproutTower1FGrannyScript, -1
	object_event  9, 11, SPRITE_TEACHER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SproutTower1FTeacherScript, -1
	object_event  3,  7, SPRITE_SAGE, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 4, TrainerSageChow, -1
	object_event 16,  9, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, SproutTower1FParlyzHeal, EVENT_SPROUT_TOWER1F_PARLYZ_HEAL
