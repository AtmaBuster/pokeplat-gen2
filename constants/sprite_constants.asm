...
; OverworldSprites indexes (see data/sprites/sprites.asm)
	...
	const SPRITE_SCIENTIST_F ; 67
	const SPRITE_2X2_ANIM_LOW ; 68
	const SPRITE_2X2_ANIM_HIGH ; 69
