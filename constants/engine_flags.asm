...
; wJohtoBadges
	const ENGINE_COALBADGE
	const ENGINE_FORESTBADGE
	const ENGINE_COBBLEBADGE
	const ENGINE_FENBADGE
	const ENGINE_RELICBADGE
	const ENGINE_MINEBADGE ; 20
	const ENGINE_ICICLEBADGE
	const ENGINE_BEACONBADGE
; wKantoBadges
...
; wVisitedSpawns
	...
	const ENGINE_FLYPOINT_JUBILIFE
	const ENGINE_FLYPOINT_OREBURGH
	const ENGINE_FLYPOINT_FLOAROMA
	const ENGINE_FLYPOINT_ETERNA
	const ENGINE_FLYPOINT_8
	const ENGINE_FLYPOINT_9
	const ENGINE_FLYPOINT_10
	const ENGINE_FLYPOINT_11
	const ENGINE_FLYPOINT_12
	const ENGINE_FLYPOINT_13
