...
; vvv unsued vvv - feel free to change
	...
	const EVENT_TOLD_ELM_ABOUT_TOGEPI_OVER_THE_PHONE ; 078
...
; Crystal-exclusive events in Johto
	...
	const EVENT_0C7
; Kanto story events
	const EVENT_GOT_NUGGET_FROM_GUY ; 0c0
	...
	const EVENT_RETURNED_LOST_ITEM_TO_COPYCAT ; 0c8
	...
	const EVENT_CLEARED_NUGGET_BRIDGE ; 0d0
	...
	const EVENT_GOT_TM42_DREAM_EATER ; 0d8
...
; Kanto hidden items
	...
	const EVENT_ROCK_TUNNEL_1F_HIDDEN_X_DEFEND ; 0e0
	...
	const EVENT_ROUTE_2_HIDDEN_REVIVE ; 0e8
	...
	const EVENT_ROUTE_25_HIDDEN_POTION ; 0f0
	...
	const EVENT_GINA_GAVE_LEAF_STONE ; 0f8
