...
; wJubilifeCitySceneID
	...
	const SCENE_JUBILIFECITY_CANT_LEAVE_GALACTIC ; 4
	const SCENE_JUBILIFECITY_NO_GLOBAL_TERMINAL  ; 5
	const SCENE_JUBILIFECITY_NOTHING             ; 6

; wOreburghCitySceneID
	const_def
	const SCENE_OREBURGHCITY_FIRST_VISIT ; 0
	const SCENE_OREBURGHCITY_AFTER_GYM   ; 1
	const SCENE_OREBURGHCITY_NOTHING     ; 2
