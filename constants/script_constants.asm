...
; ChangePartyMonForm setval arguments
	const_def 1
	const FORMCHANGE_DEOXYS_N   ; 1
	const FORMCHANGE_DEOXYS_A   ; 2
	const FORMCHANGE_DEOXYS_D   ; 3
	const FORMCHANGE_DEOXYS_S   ; 4
	const FORMCHANGE_ROTOM_NML  ; 5
	const FORMCHANGE_ROTOM_FLY  ; 6
	const FORMCHANGE_ROTOM_FRE  ; 7
	...
	const FORMCHANGE_GIRATINA_N ; 13
	const FORMCHANGE_GIRATINA_O ; 14

; ChangePartyMonForm return values
	const_def 1
	const FORMCHANGE_NOMONS     ; 1
	const FORMCHANGE_DECLINED   ; 2
	const FORMCHANGE_INVALIDMON ; 3
	const FORMCHANGE_SUCCESSFUL ; 4
