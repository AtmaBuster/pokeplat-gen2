...
EVOLVE_LEVEL_AND EQU $80
	const_def EVOLVE_LEVEL_AND
	const EVOLVE_LEVEL
	const EVOLVE_LEVEL_WITH_MOVE
	const EVOLVE_LEVEL_IN_LOCATION
	const EVOLVE_LEVEL_WITH_ITEM
	const EVOLVE_LEVEL_WITH_ITEM_DAY
	const EVOLVE_LEVEL_WITH_ITEM_NIGHT
	const EVOLVE_LEVEL_AND_MALE
	const EVOLVE_LEVEL_AND_FEMALE
	const EVOLVE_LEVEL_PARTY_MON
	const EVOLVE_LEVEL_ADD_MON
	const EVOLVE_LEVEL_EXTRA_MON
	const EVOLVE_LEVEL_DV_HIGH
	const EVOLVE_LEVEL_DV_LOW
