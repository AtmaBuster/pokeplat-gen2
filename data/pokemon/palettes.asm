...
INCBIN "gfx/pokemon/sunfish_2/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/sunfish_2/shiny.pal"
INCBIN "gfx/pokemon/sunfish_3/front.gbcpal", middle_colors
INCLUDE "gfx/pokemon/sunfish_3/shiny.pal"