...
EvosAttacksPointers::
	...
	indirect_entries NIHON_POKEMON - 1, EvosAttacksPointers4
	indirect_entries ALT_FORMS - 1, EvosAttacksPointers5
	indirect_entries NUM_POKEMON, EvosAttacksPointers6
	indirect_table_end
...
INCLUDE "data/pokemon/evos_attacks_alt_forms.asm"
