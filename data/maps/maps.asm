...
MapGroup_Dungeons:
	...
	map WaywardCave1F, TILESET_CAVE_2, DUNGEON, WAYWARD_CAVE, MUSIC_PLACEHOLDER, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map WaywardCave1F2, TILESET_CAVE_2, DUNGEON, WAYWARD_CAVE, MUSIC_PLACEHOLDER, FALSE, PALETTE_NITE, FISHGROUP_NONE
