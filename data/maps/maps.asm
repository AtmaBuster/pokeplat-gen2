...
MapGroup_CableClub:
	...
	map DebugRoom, TILESET_FACILITY, CAVE, TWINLEAF_TOWN, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE

MapGroup_Twinleaf:
	map TwinleafTown, TILESET_SINNOH_1, TOWN, TWINLEAF_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route201, TILESET_SINNOH_1, ROUTE, ROUTE_201, MUSIC_ROUTE_201, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PlayersHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, TWINLEAF_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, TWINLEAF_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RivalHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, TWINLEAF_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RivalHouse2F, TILESET_PLAYERS_ROOM, INDOOR, TWINLEAF_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TwinleafHouse1, TILESET_HOUSE, INDOOR, TWINLEAF_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TwinleafHouse2, TILESET_HOUSE, INDOOR, TWINLEAF_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	
MapGroup_Sandgem:
	map SandgemTown, TILESET_SINNOH_1, TOWN, SANDGEM_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route202, TILESET_SINNOH_1, ROUTE, ROUTE_202, MUSIC_ROUTE_201, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route219, TILESET_SINNOH_1, ROUTE, ROUTE_219, MUSIC_ROUTE_201, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map RowansLab, TILESET_LAB, INDOOR, SANDGEM_TOWN, MUSIC_PROF_ROWAN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SandgemHouse1, TILESET_HOUSE, INDOOR, SANDGEM_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AssistantHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, SANDGEM_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AssistantHouse2F, TILESET_PLAYERS_HOUSE, INDOOR, SANDGEM_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SandgemPokemonCenter1F, TILESET_POKECENTER, INDOOR, SANDGEM_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SandgemPokeMart, TILESET_MART, INDOOR, SANDGEM_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Jubilife:
	map JubilifeCity, TILESET_SINNOH_1, TOWN, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route203, TILESET_SINNOH_1, ROUTE, ROUTE_203, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route204, TILESET_SINNOH_1, ROUTE, ROUTE_204, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map JubilifeApartmentSE1F, TILESET_MODERN_INTERIOR, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifeApartmentSE2F, TILESET_MODERN_INTERIOR, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifeApartmentNE1F, TILESET_MODERN_INTERIOR, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifeApartmentNE2F, TILESET_MODERN_INTERIOR, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifeApartmentSW1F, TILESET_MODERN_INTERIOR, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifeApartmentSW2F, TILESET_MODERN_INTERIOR, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrainersSchool, TILESET_LAB, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PoketchCompany1F, TILESET_RADIO_TOWER, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PoketchCompany2F, TILESET_RADIO_TOWER, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PoketchCompany3F, TILESET_RADIO_TOWER, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation1F, TILESET_RADIO_TOWER, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation2F, TILESET_RADIO_TOWER, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation2F2, TILESET_RADIO_TOWER, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation3F, TILESET_RADIO_TOWER, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation3F2, TILESET_RADIO_TOWER, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation3F3, TILESET_RADIO_TOWER, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation4F, TILESET_RADIO_TOWER, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStationElevator, TILESET_RADIO_TOWER, INDOOR, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonCommunicationCenter, TILESET_POKECOM_CENTER, INDOOR, JUBILIFE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifePokemonCenter1F, TILESET_POKECENTER, INDOOR, JUBILIFE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifePokeMart, TILESET_MART, INDOOR, JUBILIFE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Oreburgh:
	map OreburghCity, TILESET_SINNOH_2, TOWN, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route207, TILESET_SINNOH_2, ROUTE, ROUTE_207, MUSIC_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map OreburghPokemonCenter1F, TILESET_POKECENTER, INDOOR, OREBURGH_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OreburghPokeMart, TILESET_MART, INDOOR, OREBURGH_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OreburghGym, TILESET_GYM_1, INDOOR, OREBURGH_CITY, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OreburghApartmentNW1F, TILESET_MODERN_INTERIOR, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OreburghApartmentNW2F, TILESET_MODERN_INTERIOR, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OreburghApartmentN1F, TILESET_MODERN_INTERIOR, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OreburghApartmentN2F, TILESET_MODERN_INTERIOR, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OreburghApartmentE1F, TILESET_MODERN_INTERIOR, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OreburghApartmentE2F, TILESET_MODERN_INTERIOR, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OreburghHouseW, TILESET_HOUSE, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OreburghHouseN, TILESET_HOUSE, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OreburghHouseE, TILESET_HOUSE, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OreburghMuseum, TILESET_MUSEUM, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE

	
MapGroup_Canalave:
	map JubilifeWestGate, TILESET_GATE, GATE, ROUTE_218, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route218, TILESET_SINNOH_1, ROUTE, ROUTE_218, MUSIC_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map CanalaveEastGate, TILESET_GATE, GATE, ROUTE_218, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Lakes:
	map LakeVerityLow, TILESET_LAKE, ROUTE, LAKE_VERITY, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LakeVerityHigh, TILESET_LAKE, ROUTE, LAKE_VERITY, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LakeVerityCavern, TILESET_CAVE, CAVE, LAKE_VERITY, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE

MapGroup_Dungeons:
	map OreburghGate1F, TILESET_CAVE, CAVE, OREBURGH_GATE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map OreburghGateB1F, TILESET_CAVE, CAVE, OREBURGH_GATE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map OreburghMineB1F, TILESET_CAVE, CAVE, OREBURGH_MINE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map OreburghMineB2F, TILESET_CAVE, CAVE, OREBURGH_MINE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
...
;	map SafariZoneBeta, TILESET_FACILITY, CAVE, NEW_BARK_TOWN, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
;	map HallOfFame, TILESET_ICE_PATH, INDOOR, INDIGO_PLATEAU, MUSIC_TWINLEAF_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
;
;MapGroup_Fuchsia:
...
;	map PlayersNeighborsHouse, TILESET_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;	map ElmsHouse, TILESET_PLAYERS_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
;	map Route29Route46Gate, TILESET_GATE, GATE, ROUTE_29, MUSIC_ROUTE_201, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;
;MapGroup_Saffron:
