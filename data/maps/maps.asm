...
MapGroup_CableClub:
	...
	map DebugRoom, TILESET_FACILITY, CAVE, NEW_BARK_TOWN, MUSIC_EVOLUTION, FALSE, PALETTE_AUTO, FISHGROUP_SHORE

MapGroup_Twinleaf:
	map TwinleafTown, TILESET_SINNOH_1, TOWN, NEW_BARK_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route201, TILESET_SINNOH_1, ROUTE, ROUTE_29, MUSIC_ROUTE_201, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PlayersHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PlayersHouse2F, TILESET_PLAYERS_ROOM, INDOOR, NEW_BARK_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RivalHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RivalHouse2F, TILESET_PLAYERS_ROOM, INDOOR, NEW_BARK_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TwinleafHouse1, TILESET_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TwinleafHouse2, TILESET_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_TWINLEAF_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	
MapGroup_Sandgem:
	map SandgemTown, TILESET_SINNOH_1, ROUTE, ROUTE_30, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route202, TILESET_SINNOH_1, ROUTE, ROUTE_31, MUSIC_ROUTE_201, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map RowansLab, TILESET_LAB, INDOOR, ROUTE_30, MUSIC_PROF_ROWAN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SandgemHouse1, TILESET_HOUSE, INDOOR, ROUTE_30, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AssistantHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, ROUTE_30, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map AssistantHouse2F, TILESET_PLAYERS_HOUSE, INDOOR, ROUTE_30, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SandgemPokemonCenter1F, TILESET_POKECENTER, INDOOR, ROUTE_30, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SandgemPokeMart, TILESET_MART, INDOOR, ROUTE_30, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Jubilife:
	map JubilifeCity, TILESET_SINNOH_1, TOWN, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route203, TILESET_SINNOH_1, ROUTE, SPROUT_TOWER, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map JubilifeApartmentSE1F, TILESET_MODERN_INTERIOR, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifeApartmentSE2F, TILESET_MODERN_INTERIOR, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifeApartmentNE1F, TILESET_MODERN_INTERIOR, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifeApartmentNE2F, TILESET_MODERN_INTERIOR, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifeApartmentSW1F, TILESET_MODERN_INTERIOR, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifeApartmentSW2F, TILESET_MODERN_INTERIOR, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TrainersSchool, TILESET_LAB, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PoketchCompany1F, TILESET_RADIO_TOWER, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PoketchCompany2F, TILESET_RADIO_TOWER, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PoketchCompany3F, TILESET_RADIO_TOWER, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation1F, TILESET_RADIO_TOWER, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation2F, TILESET_RADIO_TOWER, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation2F2, TILESET_RADIO_TOWER, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation3F, TILESET_RADIO_TOWER, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation3F2, TILESET_RADIO_TOWER, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation3F3, TILESET_RADIO_TOWER, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStation4F, TILESET_RADIO_TOWER, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TVStationElevator, TILESET_RADIO_TOWER, INDOOR, VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonCommunicationCenter, TILESET_POKECOM_CENTER, INDOOR, VIOLET_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifePokemonCenter1F, TILESET_POKECENTER, INDOOR, VIOLET_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map JubilifePokeMart, TILESET_MART, INDOOR, VIOLET_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE

MapGroup_Oreburgh:
	map OreburghCity, TILESET_SINNOH_2, TOWN, RUINS_OF_ALPH, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE

MapGroup_Lakes:
	map LakeVerityLow, TILESET_LAKE, ROUTE, CHERRYGROVE_CITY, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LakeVerityHigh, TILESET_LAKE, ROUTE, CHERRYGROVE_CITY, MUSIC_UNION_CAVE, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LakeVerityCavern, TILESET_CAVE, CAVE, CHERRYGROVE_CITY, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_SHORE

MapGroup_Dungeons:
	map OreburghGate1F, TILESET_CAVE, CAVE, ROUTE_32, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map OreburghGateB1F, TILESET_CAVE, CAVE, ROUTE_32, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map OreburghMineB1F, TILESET_CAVE, CAVE, RUINS_OF_ALPH, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map OreburghMineB2F, TILESET_CAVE, CAVE, RUINS_OF_ALPH, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
