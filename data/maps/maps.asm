...
MapGroup_Dungeons:
	...
	map OldChateauEntryway, TILESET_OLD_CHATEAU, CAVE, OLD_CHATEAU, MUSIC_PLACEHOLDER, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map OldChateauDining, TILESET_OLD_CHATEAU, CAVE, OLD_CHATEAU, MUSIC_PLACEHOLDER, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map OldChateauBedrooms, TILESET_OLD_CHATEAU, CAVE, OLD_CHATEAU, MUSIC_PLACEHOLDER, FALSE, PALETTE_NITE, FISHGROUP_NONE
