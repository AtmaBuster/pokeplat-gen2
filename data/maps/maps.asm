...
MapGroup_Sandgem:
	...
	map SandgemPokeMart, TILESET_MART, INDOOR, SANDGEM_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_NONE

MapGroup_Jubilife:
	map JubilifeCity, TILESET_SINNOH_1, TOWN, JUBILIFE_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map Route203, TILESET_SINNOH_1, ROUTE, ROUTE_203, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE_203
	map Route204S, TILESET_SINNOH_1, ROUTE, ROUTE_204, MUSIC_ROUTE_30, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE_203
	...
	map JubilifePokeMart, TILESET_MART, INDOOR, JUBILIFE_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_NONE

MapGroup_Oreburgh:
	map OreburghCity, TILESET_SINNOH_2, TOWN, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	...
	map OreburghPokeMart, TILESET_MART, INDOOR, OREBURGH_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OreburghGym, TILESET_GYM_1, INDOOR, OREBURGH_CITY, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OreburghApartmentNW1F, TILESET_MODERN_INTERIOR, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OreburghApartmentNW2F, TILESET_MODERN_INTERIOR, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OreburghApartmentN1F, TILESET_MODERN_INTERIOR, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OreburghApartmentN2F, TILESET_MODERN_INTERIOR, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OreburghApartmentE1F, TILESET_MODERN_INTERIOR, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OreburghApartmentE2F, TILESET_MODERN_INTERIOR, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OreburghHouseW, TILESET_HOUSE, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OreburghHouseN, TILESET_HOUSE, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OreburghHouseE, TILESET_HOUSE, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map OreburghMuseum, TILESET_MUSEUM, INDOOR, OREBURGH_CITY, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_NONE
