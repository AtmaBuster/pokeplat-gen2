...
MapGroup_Sandgem:
	map SandgemTown, TILESET_SINNOH_1, TOWN, SANDGEM_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	...
	map SandgemHouse1, TILESET_HOUSE, INDOOR, SANDGEM_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AssistantHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, SANDGEM_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map AssistantHouse2F, TILESET_PLAYERS_HOUSE, INDOOR, SANDGEM_TOWN, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Oreburgh:
	...
	map Route207, TILESET_SINNOH_2, ROUTE, ROUTE_207, MUSIC_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_Canalave:
	map JubilifeWestGate, TILESET_GATE, GATE, ROUTE_218, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_NONE
	map Route218, TILESET_SINNOH_1, ROUTE, ROUTE_218, MUSIC_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_ROUTE_218
	map CanalaveEastGate, TILESET_GATE, GATE, ROUTE_218, MUSIC_ROUTE_1, FALSE, PALETTE_DAY, FISHGROUP_NONE
...
MapGroup_Dungeons:
	...
	map OreburghGate1F, TILESET_CAVE, CAVE, OREBURGH_GATE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_NONE
	map OreburghGateB1F, TILESET_CAVE, CAVE, OREBURGH_GATE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_OREBURGH_GATE
...
;	map BlackthornDragonSpeechHouse, TILESET_HOUSE, INDOOR, BLACKTHORN_CITY, MUSIC_OREBURGH_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;	map BlackthornEmysHouse, TILESET_HOUSE, INDOOR, BLACKTHORN_CITY, MUSIC_OREBURGH_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;	map BlackthornMart, TILESET_MART, INDOOR, BLACKTHORN_CITY, MUSIC_OREBURGH_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
;	map MoveDeletersHouse, TILESET_HOUSE, INDOOR, BLACKTHORN_CITY, MUSIC_OREBURGH_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
;	map BlackthornCity, TILESET_JOHTO, TOWN, BLACKTHORN_CITY, MUSIC_OREBURGH_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
;
;MapGroup_Cinnabar:
...
;	map CharcoalKiln, TILESET_HOUSE, INDOOR, AZALEA_TOWN, MUSIC_OREBURGH_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;	map AzaleaMart, TILESET_MART, INDOOR, AZALEA_TOWN, MUSIC_OREBURGH_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;	map KurtsHouse, TILESET_TRADITIONAL_HOUSE, INDOOR, AZALEA_TOWN, MUSIC_OREBURGH_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;	map AzaleaGym, TILESET_ELITE_FOUR_ROOM, INDOOR, AZALEA_TOWN, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
;	map Route33, TILESET_JOHTO_MODERN, ROUTE, ROUTE_33, MUSIC_ROUTE_203, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
;	map AzaleaTown, TILESET_JOHTO_MODERN, TOWN, AZALEA_TOWN, MUSIC_OREBURGH_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
;
;MapGroup_LakeOfRage:
...
;
;MapGroup_Violet:
;	map Route32, TILESET_JOHTO, ROUTE, ROUTE_32, MUSIC_ROUTE_203, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH
...
;	map Route32RuinsOfAlphGate, TILESET_GATE, GATE, ROUTE_32, MUSIC_ROUTE_203, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
;	map DayCare, TILESET_HOUSE, INDOOR, ROUTE_34, MUSIC_OREBURGH_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;
;MapGroup_Vermilion:
...
;	map Route28SteelWingHouse, TILESET_HOUSE, INDOOR, ROUTE_28, MUSIC_OREBURGH_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;
;
;MapGroup_Celadon:
...
;	map Route26HealHouse, TILESET_HOUSE, INDOOR, ROUTE_26, MUSIC_OREBURGH_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;	map DayOfWeekSiblingsHouse, TILESET_HOUSE, INDOOR, ROUTE_26, MUSIC_OREBURGH_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
;	map Route27SandstormHouse, TILESET_HOUSE, INDOOR, ROUTE_27, MUSIC_OREBURGH_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
;	map Route31VioletGate, TILESET_GATE, GATE, ROUTE_31, MUSIC_ROUTE_203, FALSE, PALETTE_DAY, FISHGROUP_SHORE
