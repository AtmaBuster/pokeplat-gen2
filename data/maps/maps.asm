...
MapGroup_Twinleaf:
	map TwinleafTown, TILESET_SINNOH_1, TOWN, NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route201, TILESET_SINNOH_1, ROUTE, ROUTE_29, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map RivalHouse1F, TILESET_PLAYERS_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RivalHouse2F, TILESET_PLAYERS_ROOM, INDOOR, NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TwinleafHouse1, TILESET_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map TwinleafHouse2, TILESET_HOUSE, INDOOR, NEW_BARK_TOWN, MUSIC_NEW_BARK_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	
MapGroup_Sandgem:
	map SandgemTown, TILESET_SINNOH_1, ROUTE, ROUTE_30, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route202, TILESET_SINNOH_1, ROUTE, ROUTE_31, MUSIC_ROUTE_29, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map RowansLab, TILESET_LAB, INDOOR, ROUTE_30, MUSIC_PROF_ELM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
