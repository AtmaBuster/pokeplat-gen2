...
MapGroup_Dungeons:
	...
	map OreburghMineB1F, TILESET_CAVE, CAVE, UNION_CAVE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map OreburghMineB2F, TILESET_CAVE, CAVE, UNION_CAVE, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_SHORE
