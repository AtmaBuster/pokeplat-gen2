...
INCLUDE "maps/OreburghApartmentN1F.asm"
INCLUDE "maps/OreburghApartmentN2F.asm"
INCLUDE "maps/OreburghApartmentE1F.asm"
INCLUDE "maps/OreburghApartmentE2F.asm"
...
INCLUDE "maps/ValleyWindworksExt.asm"
