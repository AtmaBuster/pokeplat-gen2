	...
	tilecoll SPIN_RIGHT, FLOOR, FLOOR, FLOOR ; 40
	tilecoll SPIN_UP, FLOOR, FLOOR, FLOOR ; 41
	tilecoll SPIN_DOWN, FLOOR, FLOOR, FLOOR ; 42
	tilecoll SPIN_LEFT, FLOOR, FLOOR, FLOOR ; 43
	tilecoll LEFT_WALL, RIGHT_WALL, LEFT_WALL, RIGHT_WALL ; 44
	tilecoll UP_WALL, UP_WALL, DOWN_WALL, DOWN_WALL ; 45
	tilecoll STOP_SPIN, STOP_SPIN, STOP_SPIN, STOP_SPIN ; 46
