...
GracideaScript:
	opentext
	setval FORMCHANGE_SHAYMIN_S
	special ChangePartyMonForm
	ifequal FORMCHANGE_INVALIDMON, .no_effect
	ifequal FORMCHANGE_SUCCESSFUL, .success
	closetext
	end

.success
	writetext .changed_form_text
	waitbutton
	closetext
	end

.no_effect
	writetext .no_effect_text
	closetext
	end
