	...
	tilepal 0, BROWN, BROWN, BROWN, BROWN, GRAY, GRAY, GRAY, GRAY
	tilepal 0, WATER, RED, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT
...
endr
	...
	tilepal 1, GRAY, GRAY, GRAY, GRAY, BROWN, BROWN, TEXT, TEXT
	tilepal 1, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT
	tilepal 1, GRAY, GRAY, GRAY, TEXT, BROWN, BROWN, TEXT, TEXT
	tilepal 1, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT, TEXT
